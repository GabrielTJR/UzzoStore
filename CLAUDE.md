...
- **Próprias do site** (`colors`, `product_colors`, `measurement_models`, `home_sections`, `product_content` = slug/SEO, `customers`, `carts`, `cart_items`, `reservations`, `orders`, `order_items`, `payments`, `sync_state`).
